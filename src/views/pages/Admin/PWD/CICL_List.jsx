...
const CICL_List = () => {
    ...
    const buttons = [
        { label: 'CICL', route: '/admin/', icon: < Users />, color: 'bg-gray-200 hover:bg-gray-300 text-gray-800' },
        { label: 'CAR', route: '/admin/', icon: <AlertTriangle  />, color: 'bg-gray-600 hover:bg-gray-500 text-gray-200' },
        { label: 'RC', route: '/admin', icon: <ShieldAlert  />, color: 'bg-gray-600 hover:bg-gray-500 text-gray-200' },
        { label: 'AC', route: '/admin', icon: <Hand  />, color: 'bg-gray-600 hover:bg-gray-500 text-gray-200' }, 
    ];
                ...
                <div className="bg-gray-800 p-6 m-1 rounded-lg shadow-md"> 
                        ...
                        <div className="flex flex-col items-start mb-5">
                          <div className="flex w-full justify-between items-center">
                            <h1 className="font-bold text-2xl text-white uppercase tracking-wide">Children Cases</h1>  
                            <div className="flex space-x-2 -mt-1"> 
                                <button onClick={() => setOpenMenu(!openMenu)} className="p-2 rounded-full bg-gray-600 text-white shadow-md hover:bg-gray-500 transition">
                                    <FiMoreVertical className="text-xl" />
                                </button>
